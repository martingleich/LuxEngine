...
*/
size_t IntToString(intmax_t data, char* str, int base=10);
...
\return The number of bytes written, without the terminating null
*/
size_t UIntToString(uintmax_t data, char* str, int base=10);
...
\return The number of bytes written, without the terminating null
*/
size_t FloatToString(double data, char* str, int precision=3);
