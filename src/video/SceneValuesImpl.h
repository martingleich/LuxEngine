...
public:
	...
	void SetLight(u32 id, const video::LightData& light);
	void ClearLights();
...
private:
	struct Param
	{
		...
		Param(const string& _Name, u32 _Offset, core::Type _Type, u32 _Size) :
			name(_Name), offset(_Offset), type(_Type), size(_Size)
		{
		}
	};
...
private:
	...
	u32 GetParamIdUnsafe(const string& name) const;
...
private:
	...
	core::mem::RawMemory m_ParamData;
	u32 m_CurrentOffset;
