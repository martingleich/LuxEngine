...
struct VertexDeclInitType
{
	VertexDeclInitType()
	{
		...
		assert(VertexDeclaration_STANDARD.IsValid());
		...
		assert(VertexDeclaration_TRANSFORMED.IsValid());
		...
		assert(VertexDeclaration_TWO_TEXTURE.IsValid());
		...
		assert(VertexDeclaration_TANGENTS.IsValid());
		...
		assert(VertexDeclaration_TEXTURE_3D.IsValid());
		...
		assert(VertexDeclaration_STANDARD_2D.IsValid());
	}
};
