...
private:
	...
	bool AllowTest(const Test* t) const;
...
public:
	...
	virtual bool OnTestEnd(const TestResult& result)
	{
		return false;
	}
...
static const char* USE_PARENT_FILE = "";

}

#define MAKE_WIDE_STRING_EXPAND(x) x
...
static UnitTesting::Test Test_##name(Suite, &TestFunc_##name, UnitTesting::Info(#name, UnitTesting::USE_PARENT_FILE, __LINE__)); \
